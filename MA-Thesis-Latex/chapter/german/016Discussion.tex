...
Der Vergleich zwischen vortrainierten und von Grund auf trainierten Modellen zeigt, dass die \acrshort{YOLO}-Version selbst nur einen geringen Einfluss auf die Performance hat. Über alle drei spektralen Permutationen hinweg schneiden die von scratch trainierten \acrshort{YOLO}v9-Modelle gleich gut oder besser ab als die neueren YOLOv12-Modelle. Die geringere Leistung des von scratch trainierten \acrshort{YOLO}v12-Modells könnte auf einen anderen Entwicklungsschwerpunkt zurückzuführen sein. Durch die Implementierung der \acrshort{AA2}- und \acrshort{R-ELAN}-Methoden wurde bei \acrshort{YOLO}v12 möglicherweise der Fokus stärker auf Echtzeitdetektion und -klassifizierung gelegt, was zu einer reduzierten Performance in anderen Anwendungsfällen, wie der Objekterkennung und -klassifizierung auf Videostreams, geführt haben könnte.

% \begin{itemize}
%     \item beim vergleich der vortrainierten und von scratch trainierten Modelle zeigt isch das die YOLO Version kaum einen Utnerscheid bei der Performacne macht. Es zeigt sich über alle 3 Permuationen hinweg, dass die neueren YOLOv12 Modelle schlechter oder nahezu gleich gut abschneidet als die von scratch trainierten YOLOv9 Modelle
%     \item Das schlechte Abschnedien des von scratch trainierten yolov12 modelles konnte an einem anderen Entwicklugnsschwerpunkt liegen, der bei der Entwicklung gesetzt wurde. Durch die Implementierung des \acrshort{AA2} und \acrshort{R-ELAN} könnte bei der Version ein Fokus auf Echtzeitdetektion und klassifzierung gesetzt worden sein, was zu einer schlechteren Performacne bei anderen Anwendungsfällen, als Objektklassifizierung und Detetkion auf Videostreams, geführt haben könnte
% \end{itemize}
