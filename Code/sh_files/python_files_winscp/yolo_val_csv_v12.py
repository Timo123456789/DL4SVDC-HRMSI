...
# Pfade
model_path = f"/scratch/tmp/t_liet02/new_val_detect_v12/{perm_set}/fold{fold_id}/weights/best.pt"
output_csv = f"/scratch/tmp/t_liet02/new_val_detect_v12/{perm_set}/fold{fold_id}/metrics_and_confusion_val.csv"
...
results = model.val(
    ...
    save_conf=True,
    exist_ok=True,
    project=f"/scratch/tmp/t_liet02/new_val_detect_v12/{perm_set}/fold{fold_id}"
)
...
model_path = f"/scratch/tmp/t_liet02/new_val_detect_v12/{perm_set}/fold{fold_id}/weights/best.pt"
output_csv = f"/scratch/tmp/t_liet02/new_val_detect_v12/{perm_set}/fold{fold_id}/metrics_and_confusion_test.csv"
