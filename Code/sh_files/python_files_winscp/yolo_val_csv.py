...
# Pfade
model_path = f"/scratch/tmp/t_liet02/cross_validation_ablation/{perm_set}/fold{fold_id}/weights/best.pt"
output_csv = f"/scratch/tmp/t_liet02/cross_validation_ablation/{perm_set}/fold{fold_id}/metrics_and_confusion_val.csv"
...
model_path = f"/scratch/tmp/t_liet02/cross_validation_ablation/{perm_set}/fold{fold_id}/weights/best.pt"
output_csv = f"/scratch/tmp/t_liet02/cross_validation_ablation/{perm_set}/fold{fold_id}/metrics_and_confusion_test.csv"
